...
class Pagoa extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['user_id', 'provedor_id', 'cuenta_id', 'fecha', 'referencia', 'cliente', 'concepto', 'bl', 'contenedor', 'factura', 'pago_path', 'solicitud_path',  'cantidad', 'moneda', 'obeservacion','comprobante_path' , 'obeservacionderev', 'status'];

        ...
        <div class="col-md-12">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <span class="card-title" style="color:#FFFFFF">Editar Pago Aduocomer</span>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('pagoas.update',$pago->id) }}" " role="form" enctype="multipart/form-data">
                        {{ method_field('PATCH') }}
                        @csrf
